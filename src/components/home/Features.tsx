  ...
  const pillars = [
    {
      ...
      description: "Promoting Quranic wisdom and Islamic values among students across academic institutions.",
    },
    {
      icon: <ShieldCheck className="w-8 h-8 text-ati-red" />,
      title: "Character Building",
      description: "Focusing on moral development, self-discipline, and ethical leadership practices.",
    },
    {
      icon: <Users className="w-8 h-8 text-ati-green" />,
      title: "Student Leadership",
      description: "Empowering the next generation of professionals to lead with competence and integrity.",
    },
    {
      icon: <HeartHandshake className="w-8 h-8 text-ati-red" />,
      title: "Social Welfare",
      description: "Actively participating in community service, relief work, and standing for student rights.",
    },
  ];

  // Container motion variant for cascading animation effect
  const containerVariants = {
    hidden: { opacity: 0 },
    visible: {
      opacity: 1,
      transition: {
        staggerChildren: 0.15, // Har card 0.15 seconds ke gap se aye ga
      },
    },
  };
    ...
    <section className="py-24 bg-gradient-to-b from-background via-gray-50/50 to-background">
      <div className="container mx-auto px-4">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          >
            For decades, ATI has been working tirelessly to guide student energy towards positive, intellectual, and revolutionary growth.
          </motion.p>
        </div>
        ...
        >
          {pillars.map((pillar, index) => (
            ...
            >
              {/* Subtle top border bar indicator on hover */}
              ...
              <div>
                {/* Icon Container with smooth bounce rotation wrapper */}
              ...
              {/* Dynamic Learn More indicator button */}
